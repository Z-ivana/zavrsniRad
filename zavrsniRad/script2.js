...
var cStorage = function () {
    var saveToCookiesStorage = function (cookieName, objectToSave, exHours) { // ovo ne radi ne znam zasto
        var d = new Date();
    ...
    var delFromCookiesStorages = function (cookieName) {
...
var search = function () {
   ...
   document.getElementById("searchButton").addEventListener("click",function () {
    ...
    if(find==false) 
    span.textContent="Nema trazene knjige";
